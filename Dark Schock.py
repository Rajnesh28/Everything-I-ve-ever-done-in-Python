...
inventory= []
def bullet():
    print("This is the Bullet from the crime scene")
    print("It says PH's Gun on it")
def Sheet():
    print("Ayyad's sheets, pretty clueless gun store, to give him a gun")
def key():
    print("This is the key to that unknown room")
def crime_scene():
...
def opening():
    ...
    list.append(raj)
    print((list[1]),"You Are Led To The Crime Scene")
    ...
    if gunstore_travel == "no":
        ...
        print("Officer Jake: Sorry, Detective, but we couldn't find anything, but we'll stay here and continue looking around")
        print("Officer Jake: Here take the bullet with you, and go to PH's")
        list.append(bullet)
        if bullet in list:
            print("Bullet Added To Inventory")
    if gunstore_travel == "yes":
        print("Officer Jake: Alright, I'll send a driver to pick you up, here is the bullet")
        list.append(bullet)
        if bullet in list:
            print("Bullet Added To Inventory")
...
def PH_GunStore():
    ...
    print("Cornelius:Only one person bought that bullet in the past week, Ayyad")
    ...
    print((list[1]),"Then why'd you give him the bullet and gun!Look I don't have time for this, Ayyad, huh, print out the information")
    print("You take the sheets of papers")
    list.append(Sheet)
    if Sheet in list:
        print("Sheets Added To  Inventory")
...
def Route_To_NYPD():
    ...
    print((list[1]),"I thought this was my taxi")
    print("Driver: Quiet, his destination is up ahead, just relax")
    print("The man seemed tensed")
    leavecar=input("Do you want out of the car?: ")
    if leavecar == "yes":
        print((list[1]),"I am going to go now")
        time.sleep(.3)
...
def Warehouse():
    ...
    if chair_exit == "1":
        ...
        if rope_cut == "yes":
            ...
            print("You grab the bullet and break out of your seat")
            print("That feels soar, ahh")
            print("You stretch and after leave the room")
            print("You see a metal door")
            print("You walk in and see a man, locked up by arms and legs, chained to the wall")
        if rope_cut == "no":
    ...
    if chair_exit == "2":
        ...
        print("Dmitri: Well maybe when you learn not to...")
        print("There voices begin to become mutters, and they stray off as the three walk down the hallway")
        print((list[1]),"Well I still gotta get outta here, and maybe get some brunch after")
        print("You grab the bullet and break out of your seat")
        print("That feels soar, ahh")
        print("You stretch and after leave the room")
        print("You see a metal door")
        print("You walk in and see a man, locked up by arms and legs, chained to the wall")
def TK_Truth():
    print("You walk up to the hostage")
...
def BombHouse():
    print("What?!")
    print("How?!")
    print("A bomb a bit larger than a biology textbook")
    print("You've learned about this one before")
    print("HPR32 Explosive Detonation")
    print("You remember hearing this back when you were studying to be in the bomb squad")
    print("We both know that didn't go altogether")
    print("But let's talk about more about the bomb and your expeirence to it")
    print("Now this bomb, its no joke")
    print("Take out all of time square in a flash")
    print("You don't have a clue how the Blue  Crimson gang got hold of this massive arsenal")
    print("But it shocks you, you still remember the emphasis you professor made when he first introduced this to you")
    print("But now, lets get back to the real world")
    print("The bomb is right in front of you, tampering with it or mishandling it will cause it to detonate")
    print("Defusing it, very hard task")
    print("Something you don't even know")
    print("Type 1 For - Killed The Guard")
    print("Type 2 For - Sneaked")
    bananas=input("You hear a whisper, did you take him out or did you sneak and grab a key:? ")
    if bananas == "1":
        print("From outside the warehouse you hear")
        print("Dmitri: Jake, who did this to JAKE")
        print("You slowly close the door fast, so no one knows it is open")
        print("More footsteps than last time, and they are all rushing down the hallway")
        print("And they are getting extremely louder")
        print("And they stop")
        print("Right in front of the hostage's door")
        print("Dmitri: WHO LET YOU FREE...YOU MUST'VE KILLED JAKE")
        print("Hostage: I didn't do sh")
        print("Dmitri pulls out his gun and shoots the hostage dead")
        print("Disgusting, truly disgusting")
        print("Armeh: 'Ehh Boss' Armeh says running down the hallway")
        print("Armeh: Jake's key isn't on him")
        print("After a glare at each other they both start running and this time you know they are coming for your")
        print("You see the window")
        print("You grab the bomb, and you run to the window")
        print("Attemting to see if you can negotiate and threaten the bomb as your way out of this")
    if bananas == "2":
        print("You can hear a car screech at the door")
        print("Dmitri: How's the lookout")
        print("Unknown: Fine boss, how's brunch")
        print("Dmitri: we got hot dogs, and Armeh a happy meal")
        print("Armeh is playing with his toy in the background")
        print("'The door opens and after a little while")
        print("Dmitri: Ehh who left the bombhouse open")
        print("This is serious, they are coming to you and possible end up killing you")
        print("You run to the window with the bomb, and use it as means of negotating")
def Ledge():
